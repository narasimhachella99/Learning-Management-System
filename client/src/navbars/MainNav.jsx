...
const MainNav = () => {
    return (
        <div>
            <nav className=" mt-5 mx-auto block w-full max-w-screen-xl rounded-xl border border-white/80 bg-pink-200 bg-opacity-80 py-2 px-4 text-white shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
                <div>
                    <div className="container mx-auto flex items-center justify-between text-gray-900">
                        ...
                        <a
                            href="/"
                            className="mr-10 block cursor-pointer py-1.5 font-sans text-sm font-normal leading-normal text-inherit antialiased"
                        >
