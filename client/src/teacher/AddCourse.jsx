  ...
  return (
    <div className="bg-gradient-to-l from-blue-500 to-green-300 h-screen">
      ...
      <div className="flex justify-center w-full mt-10 ">
        <div className="w-7/12 mt-5 p-8 shadow-lg">
          <h2 className="text-3xl  ">Add Course</h2>
          <form
            onSubmit={handleSubmit((data) => {
              try {
                const res = axios.post(
                  `http://192.168.1.204:8080/api/Courses`,
                  data
                );
          ...
          >
            <div className="gap-2 flex">
              <div className="relative md:w-1/2 h-10 w-full mt-10">
                <input
                  {...register("name")}
            ...
            <button
              className=" w-full mt-5 none center rounded-lg bg-pink-200 py-2 px-6 font-sans text-xs font-bold uppercase text-black shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
